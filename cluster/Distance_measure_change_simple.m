...
path_before='C:\Users\athomaz\Google Drive\superresolution\analysis\mycodes\superres-matlab\cluster\data test\plot by distance\CTR';
...
cutOff = find(Homer_Center_before(:,1)>cut);
...
path_after='C:\Users\athomaz\Google Drive\superresolution\analysis\mycodes\superres-matlab\cluster\data test\plot by distance';
...
cutOff2 = find(Homer_Center_after(:,1)>cut);
...
%%
% output
xlswrite(strcat(userdirin,'dist-change-homer-nmdar-far4000-CTR.xlsx'), dist_change);