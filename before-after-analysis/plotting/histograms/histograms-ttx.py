...
mybins  = np.arange(-500,500,20)
xlim = (-300,300)
ylim = (0,0.006)


#File names
fileName_CTR5 = 'homer-ampar-before-after-diff-trace-dist-CTR-5.xlsx'
fileName_CTR6 = 'homer-ampar-before-after-diff-trace-dist-CTR-6.xlsx'
...
fileName_LTD6  = 'homer-ampar-before-after-diff-trace-dist-LTD-6.xlsx'
fileName_LTD7  = 'homer-ampar-before-after-diff-trace-dist-LTD-7.xlsx'
...
plt.figure()
sns.distplot(distChange_LTD, label='LTD', bins=mybins, kde=False , hist_kws=dict(edgecolor="k", linewidth=1))
sns.distplot(distChange_CTR, label='CTR', bins=mybins, kde=False, hist_kws=dict(edgecolor="k", linewidth=1))
...
plt.ylabel('Counts')
plt.title('Relative Distance Between Cluster Centers Homer-Ampar')
...
plt.ylabel('Counts')
plt.title('Diffusion Coefficient of AMPAR before and after CTR')
plt.legend()
...
plt.xlabel('D ' + r'($\mu m^2/s, log)$')
plt.ylabel('Counts')
plt.title('Diffusion Coefficient of AMPAR before and after LTD')
plt.legend()
...
plt.ylabel('Counts')
plt.title('Trace Range Before and After CTR')
plt.legend()
...
plt.xlabel('Trace Range ' + r'($\mu m)$')
plt.ylabel('Counts')
plt.title('Trace Range Before and After LTD')
plt.legend()
