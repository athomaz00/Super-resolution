...
#File names
fileName_CTR5 = 'homer-ampar-before-after-distance-CTR-5.xlsx'
fileName_CTR6 = 'homer-ampar-before-after-distance-CTR-6.xlsx'
...
fileName_LTD6  = 'homer-ampar-before-after-distance-LTD-6.xlsx'
fileName_LTD7  = 'homer-ampar-before-after-distance-LTD-7.xlsx'
...
plt.figure()
sns.distplot(distChange_LTD, label='LTD', bins=mybins, kde=False , hist_kws=dict(edgecolor="k", linewidth=1, normed=True))
sns.distplot(distChange_CTR5, label='CTR', bins=mybins, kde=False, hist_kws=dict(edgecolor="k", linewidth=1, normed=True))
